...
## Purpose
Provides a first-time user onboarding experience through an AI-guided welcome conversation screen and profile display popup. Frontend only - backend integration via props.
